          ...
          return(
            <tr id={i._id}>
                <td className='namedata'>
                  <input type='text' maxlength='3' defaultValue={i.yourname} onChange={e => {i.yourname = e.target.value}}></input>
                </td>
                <td className='scoredata'>
                  <input type='number' defaultValue={i.score} onChange={e => {i.score = e.target.value}}></input>
                </td>
                <td className='locationdata'>
                  <input type='text' defaultValue={i.location} onChange={e => {i.location = e.target.value}}></input>
                </td>
                <td>
                <button onClick={() => this.delete(i._id)}>Delete</button>
                </td>
                <td>
                <button onClick={() => this.edit(i._id)}>Edit</button>
                </td>
              </tr>
          )
        }
